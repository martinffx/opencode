...
export const Flag = {
  ...
  OPENCODE_EXPERIMENTAL_CACHE: OPENCODE_EXPERIMENTAL || truthy("OPENCODE_EXPERIMENTAL_CACHE"),
  ...
  OPENCODE_EXPERIMENTAL_CUSTOMIZE_SKILL: enabledByExperimental("OPENCODE_EXPERIMENTAL_CUSTOMIZE_SKILL"),
